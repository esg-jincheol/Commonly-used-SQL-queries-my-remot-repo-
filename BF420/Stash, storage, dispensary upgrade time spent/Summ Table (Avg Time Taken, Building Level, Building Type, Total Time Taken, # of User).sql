/***************************************************/
/* Summary table of AVERAGE time taken to level up */
/***************************************************/
SELECT type, new_level, COUNT(DISTINCT user_id) AS user_number, SUM(time_diff_minutes)::FLOAT/60 AS total_time_taken, total_time_taken::FLOAT/user_number AS avg_time_taken
FROM
(
